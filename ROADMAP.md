...
> **当前状态（2026-07-11）**：M1 ✅、M2 ✅、M3 ✅。拼音 IME 已可安装使用（`make install-ime`，菜单栏选「aime拼音」），含错测试集首选准确率 85–90%。下一步：M4 双模态融合（语音入 composition、回改键、共享词库双向增强）；欠账：双拼、真人录音测试集、M1 Air 基准、XPC 签名校验、IME 实机兼容性走查。
